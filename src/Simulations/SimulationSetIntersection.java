...
public class SimulationSetIntersection {
	public static void main(String[] args) {
		...
		ArrayList<BigInteger> encryptionsList = Bob.generateIntersectionEncryptions(P1Enc);
		System.out.println("Encryptions List generated -> size: " + encryptionsList.size());

		// STEP 3: Alice generates intersection set
		ArrayList<Integer> unionSet = Alice.getIntersectionSet(encryptionsList);
